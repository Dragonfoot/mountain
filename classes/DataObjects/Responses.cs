    ...
    [Serializable] public class StringResponses {
        ...
        private void PopulateLists() {
            string[] responses = {
                ...
                "No problem, I seem to remember doing %% successfully in my sleep all the time, just a sec...zzzz..",
                ...
                "%% - Maybe, if you started treating me like the god I am, I'd find a way to actually do this really weird request of yours.",
                "%% - Humph.. I see typing isn't one of our strong suits.",
                "%% - Drinking again are we?",
                "%% - Give me a break. And put some cloths on before you type anything more! Sheesh!",
                "%%.. OK, now I'm having a wee giggle fit.",
                "%% - *blush*",
                "%% - last time I tried that my ears curled.",
                ...
                "%% - umm..some advice.. on the keyboard of life, always keep one finger on the escape key and both elbows off the rest.",
                ...
                "%% - I know you only drink alcohol to make me seem more interesting.. so just how's that working for you at this moment?",
                "%% - so just what is it we're smoking today?",
                ...
                "%% - You are definitely validating my inherent mistrust of strangers once again.",
